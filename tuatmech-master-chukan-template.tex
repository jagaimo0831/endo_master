...
\keyword{浮遊感, 羽ばたいて飛ぶ感覚, 仮想翼, EMS, 四肢以外}
]
\begin{small}
\section{緒　　言}
仮想空間で人に浮遊感を与える研究において，視覚の変化を与えることによって飛ぶ感覚を与える研究は数多くある．しかし鳥のように翼を動かして飛ぶ感覚を与える研究は少ない．さらに言えば，トビトカゲのように四肢から独立した翼を持つ生き物になりきって飛ぶ感覚を与える研究は見当たらない．
...
%ヒト→デバイス部分よりも，デバイス→ヒト部分の方が重要hogeとか書けると良いな

\section{実験方法}
実験方法の概要を\figref{experimental_method}に示す．

\begin{figure}[b]
  \begin{center}
  \includegraphics[width=0.75\hsize]{\FIGDIR/experimental_method}%
