...
% 実験の様子を表した図や写真も欲しい
  ...
  \subsection{実験結果と考察}
        ...
        \figpos{subjectexp-result_emg_pos.png}{width=.86\hsize}{Comparison of EMG measuring position}{t}

        \figpos{subjectexp-result_vib_or_ems.png}{width=.86\hsize}{Comparison of Vibration and EMS}{t}

        \figpos{subjectexp-result_mesure_or_presen.png}{width=.86\hsize}{Comparison of measuring position and haptics presentation position}{t}
