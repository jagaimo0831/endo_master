...
\section{緒言}
  ...
  \subsection{本研究での羽ばたいて飛ぶ感覚の定義}
    ...
    \fig{intro-Classification_of_floating_feeling.pdf}{width=.9\hsize}{Classification of floating feeling}
...
\section{提案手法を用いた身体像拡張の主観評価実験}
  ...
  \subsection{主観評価実験を行う実験環境}
    ...
    そして，視覚提示装置は3人称視点と1人称視点を比較するため，液晶モニターでの視覚提示とHMDを用いた視覚提示の2種類を準備する．液晶モニターはGW2765HT（BenQ），HMDはMeta社のQuest（\figref{hmd-oculus_quest.jpg}）\cite{OculusQuest}を使用する．視覚提示する際に使用する仮想翼を\figref{exprtiment-VirtualWings_skeleton.pdf}に示す．
