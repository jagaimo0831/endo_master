...
% 実験の様子を表した図や写真も欲しい
        ...
        \fig{subjectexp-haptic_dev_motor.png}{width=0.6\hsize}{（写真だけだと何もわからないので回路図か何かを併記するべき）Haptics display device（Vibration）}

        \fig{subjectexp-haptic_dev_ems.png}{width=0.6\hsize}{（写真だけだと何もわからないので回路図か何かを併記するべき）Haptics display device（EMS）}
